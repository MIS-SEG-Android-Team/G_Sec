package org.rmj.guanzongroup.gsecurity.data.remote.param.notification;

public class SendVisitedPlaceParams {
    ...
    public String getSRemarks() { return sRemarks; }
    public void setSRemarks(String value) { this.sRemarks = value; }
}
