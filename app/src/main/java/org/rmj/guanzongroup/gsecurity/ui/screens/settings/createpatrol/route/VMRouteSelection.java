...
public class VMRouteSelection extends ViewModel {
    ...
    public void initializeCreatedSchedule(ScheduleEntity value) {
    ...
    public void saveRouteSelection() {
        ...
        Objects.requireNonNull(schedule.getValue()).setSRoutexxx(routes);

        scheduleRepository.updateSchedule(schedule.getValue());
    }
}